...
<script src="assets-template/plugins/jquery/jquery.min.js"></script>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
       ...
       <h1 class="brand-text font-weight-light" style="font-size: 2.5rem; color: #ffffffff; display: flex; align-items: center; gap: 10px;">
  <i class="fas fa-database"></i> NULL PHP
</h1> 
